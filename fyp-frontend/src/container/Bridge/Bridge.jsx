...
const Bridge = () => (
  <div className="app__bridge section__padding" id="about">
    <div className="flex__center" style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'column', paddingBottom: '2rem' }}>
      <h1 className="p__cormorant_white" style={{ fontSize: '2rem', textShadow: '0px 0px 4px rgba(0, 0, 0, 0.5)', marginBottom: '1rem' }}>Cooperated with</h1>
